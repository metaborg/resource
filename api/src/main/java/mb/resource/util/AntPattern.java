...
public final class AntPattern implements Serializable {
    ...
    @Override public boolean equals(Object o) {
        ...
        final AntPattern that = (AntPattern) o;
        if(isCaseSensitive != that.isCaseSensitive) return false;
        return Arrays.equals(tokenizedPattern, that.tokenizedPattern);
    }

    @Override public int hashCode() {
        int result = Arrays.hashCode(tokenizedPattern);
        result = 31 * result + (isCaseSensitive ? 1 : 0);
        return result;
    }

    @Override public String toString() {
        return String.join(SEPARATOR, tokenizedPattern);
    }
}
