...
public interface ResourceService {
     ...
     *                                  when qualifier of given {@code key} does not correspond to a
     *                                  {@link ResourceRegistry} in this resource service.
     */
    Resource getResource(ResourceKey key);

    /**
     * Gets a readable resource for given key.
     *
     * @param key Key to get resource for.
     ...
     *                                  when qualifier of given {@code key} does not correspond to a
     *                                  {@link ResourceRegistry} in this resource service.
     * @throws ResourceRuntimeException when resource for given {@code key} does not implement {@link ReadableResource}.
     */
    ReadableResource getReadableResource(ResourceKey key);

    /**
     * Gets a writable resource for given key.
     *
     ...
     *                                  when qualifier of given {@code key} does not correspond to a
     *                                  {@link ResourceRegistry} in this resource service.
     * @throws ResourceRuntimeException when resource for given {@code key} does not implement {@link WritableResource}.
     */
